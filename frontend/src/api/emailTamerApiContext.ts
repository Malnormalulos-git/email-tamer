...
import { QueryOperation } from './emailTamerApiComponents';

export type EmailTamerApiContext<
 ...
 */
export function useEmailTamerApiContext<
  TQueryFnData = unknown,
  TError = DefaultError,
  TData = TQueryFnData,
  TQueryKey extends QueryKey = QueryKey,
>(
    ...
    'queryKey' | 'queryFn'
  >,
): EmailTamerApiContext<TQueryFnData, TError, TData, TQueryKey> {
    return {
        fetcherOptions: {},
        queryOptions: {},
    };
